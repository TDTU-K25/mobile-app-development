...
import com.example.ex1.network.Downloader;
import com.example.ex1.recycler.DownloadFile;
import com.example.ex1.recycler.FileAdapter;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, Downloader.Callback {
    ...
    private void downloadFile(String url) {
        ...
        File fileUpload = Paths.get(url).toFile();
        String name = fileUpload.getName();
        downloadFile.setLocalPath(parent.getPath() + "/" + name); // already set name and if set name then already set icon
