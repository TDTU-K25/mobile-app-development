...
import com.example.ex2.adapter.Music;
import com.example.ex2.adapter.MusicAdapter;
...
public class MainActivity extends AppCompatActivity implements MusicAdapter.OnMusicClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataSource.add(new Music("Từng quen", R.raw.tung_quen));
        dataSource.add(new Music("Đã lỡ yêu em nhiều", R.raw.da_lo_yeu_em_nhieu));
        dataSource.add(new Music("Thằng điên", R.raw.thang_dien));
