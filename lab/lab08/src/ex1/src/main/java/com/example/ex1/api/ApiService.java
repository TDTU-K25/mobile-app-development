...
public interface ApiService {
    ...
    ApiService apiService = new Retrofit.Builder().baseUrl("http://10.0.2.2:8888/api/").addConverterFactory(GsonConverterFactory.create(gson)).build().create(ApiService.class);
